...
module soc_system_mm_interconnect_0 (
		...
		input  wire [31:0]  Stream_to_Mem_avalon_dma_master_address,                            //                              Stream_to_Mem_avalon_dma_master.address
		output wire         Stream_to_Mem_avalon_dma_master_waitrequest,                        //                                                             .waitrequest
		input  wire         Stream_to_Mem_avalon_dma_master_write,                              //                                                             .write
		input  wire [31:0]  Stream_to_Mem_avalon_dma_master_writedata,                          //                                                             .writedata
	...
	wire          stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_waitrequest;   // Stream_to_Mem_avalon_dma_master_agent:av_waitrequest -> Stream_to_Mem_avalon_dma_master_translator:uav_waitrequest
	wire   [31:0] stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_readdata;      // Stream_to_Mem_avalon_dma_master_agent:av_readdata -> Stream_to_Mem_avalon_dma_master_translator:uav_readdata
	wire          stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_debugaccess;   // Stream_to_Mem_avalon_dma_master_translator:uav_debugaccess -> Stream_to_Mem_avalon_dma_master_agent:av_debugaccess
	wire   [31:0] stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_address;       // Stream_to_Mem_avalon_dma_master_translator:uav_address -> Stream_to_Mem_avalon_dma_master_agent:av_address
	wire          stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_read;          // Stream_to_Mem_avalon_dma_master_translator:uav_read -> Stream_to_Mem_avalon_dma_master_agent:av_read
	wire    [3:0] stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_byteenable;    // Stream_to_Mem_avalon_dma_master_translator:uav_byteenable -> Stream_to_Mem_avalon_dma_master_agent:av_byteenable
	wire          stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid; // Stream_to_Mem_avalon_dma_master_agent:av_readdatavalid -> Stream_to_Mem_avalon_dma_master_translator:uav_readdatavalid
	wire          stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_lock;          // Stream_to_Mem_avalon_dma_master_translator:uav_lock -> Stream_to_Mem_avalon_dma_master_agent:av_lock
	wire          stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_write;         // Stream_to_Mem_avalon_dma_master_translator:uav_write -> Stream_to_Mem_avalon_dma_master_agent:av_write
	wire   [31:0] stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_writedata;     // Stream_to_Mem_avalon_dma_master_translator:uav_writedata -> Stream_to_Mem_avalon_dma_master_agent:av_writedata
	wire    [2:0] stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_burstcount;    // Stream_to_Mem_avalon_dma_master_translator:uav_burstcount -> Stream_to_Mem_avalon_dma_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                  // rsp_mux:src_valid -> Stream_to_Mem_avalon_dma_master_agent:rp_valid
	wire  [113:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> Stream_to_Mem_avalon_dma_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                  // Stream_to_Mem_avalon_dma_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [2:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> Stream_to_Mem_avalon_dma_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                          // rsp_mux:src_startofpacket -> Stream_to_Mem_avalon_dma_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                            // rsp_mux:src_endofpacket -> Stream_to_Mem_avalon_dma_master_agent:rp_endofpacket
	...
	wire          rsp_mux_001_src_valid;                                                              // rsp_mux_001:src_valid -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_valid
	wire  [113:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                              // alt_vip_cl_vfb_0_mem_master_rd_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                      // rsp_mux_001:src_startofpacket -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                        // rsp_mux_001:src_endofpacket -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_endofpacket
	...
	wire  [113:0] rsp_mux_002_src_data;                                                               // rsp_mux_002:src_data -> alt_vip_cl_vfb_0_mem_master_wr_agent:rp_data
	...
	wire          stream_to_mem_avalon_dma_master_agent_cp_valid;                                     // Stream_to_Mem_avalon_dma_master_agent:cp_valid -> router:sink_valid
	wire  [113:0] stream_to_mem_avalon_dma_master_agent_cp_data;                                      // Stream_to_Mem_avalon_dma_master_agent:cp_data -> router:sink_data
	wire          stream_to_mem_avalon_dma_master_agent_cp_ready;                                     // router:sink_ready -> Stream_to_Mem_avalon_dma_master_agent:cp_ready
	wire          stream_to_mem_avalon_dma_master_agent_cp_startofpacket;                             // Stream_to_Mem_avalon_dma_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          stream_to_mem_avalon_dma_master_agent_cp_endofpacket;                               // Stream_to_Mem_avalon_dma_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [113:0] alt_vip_cl_vfb_0_mem_master_rd_agent_cp_data;                                       // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_data -> router_001:sink_data
	...
	wire  [113:0] alt_vip_cl_vfb_0_mem_master_wr_agent_cp_data;                                       // alt_vip_cl_vfb_0_mem_master_wr_agent:cp_data -> router_002:sink_data
	...
	wire  [113:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> hps_0_f2h_sdram0_data_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                  // hps_0_f2h_sdram0_data_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> hps_0_f2h_sdram0_data_cmd_width_adapter:in_channel
	...
	wire  [365:0] hps_0_f2h_sdram0_data_cmd_width_adapter_src_data;                                   // hps_0_f2h_sdram0_data_cmd_width_adapter:out_data -> hps_0_f2h_sdram0_data_agent:cp_data
	...
	wire    [2:0] hps_0_f2h_sdram0_data_cmd_width_adapter_src_channel;                                // hps_0_f2h_sdram0_data_cmd_width_adapter:out_channel -> hps_0_f2h_sdram0_data_agent:cp_channel
	...
	wire          router_003_src_valid;                                                               // router_003:src_valid -> hps_0_f2h_sdram0_data_rsp_width_adapter:in_valid
	wire  [365:0] router_003_src_data;                                                                // router_003:src_data -> hps_0_f2h_sdram0_data_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                               // hps_0_f2h_sdram0_data_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [2:0] router_003_src_channel;                                                             // router_003:src_channel -> hps_0_f2h_sdram0_data_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                                       // router_003:src_startofpacket -> hps_0_f2h_sdram0_data_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                                         // router_003:src_endofpacket -> hps_0_f2h_sdram0_data_rsp_width_adapter:in_endofpacket
	...
	wire  [113:0] hps_0_f2h_sdram0_data_rsp_width_adapter_src_data;                                   // hps_0_f2h_sdram0_data_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [2:0] hps_0_f2h_sdram0_data_rsp_width_adapter_src_channel;                                // hps_0_f2h_sdram0_data_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [113:0] cmd_demux_002_src0_data;                                                            // cmd_demux_002:src0_data -> crosser_002:in_data
	...
	wire  [113:0] crosser_002_out_data;                                                               // crosser_002:out_data -> cmd_mux:sink2_data
	...
	wire  [113:0] rsp_demux_src0_data;                                                                // rsp_demux:src0_data -> crosser_003:in_data
	...
	wire  [113:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux:sink0_data
	...
	wire  [113:0] rsp_demux_src1_data;                                                                // rsp_demux:src1_data -> crosser_004:in_data
	...
	wire  [113:0] crosser_004_out_data;                                                               // crosser_004:out_data -> rsp_mux_001:sink0_data
	...
	wire  [113:0] rsp_demux_src2_data;                                                                // rsp_demux:src2_data -> crosser_005:in_data
	...
	wire  [113:0] crosser_005_out_data;                                                               // crosser_005:out_data -> rsp_mux_002:sink0_data
	...
	) stream_to_mem_avalon_dma_master_translator (
		.clk                    (pll_sys_outclk2_clk),                                                                //                       clk.clk
		.reset                  (Stream_to_Mem_reset_reset_bridge_in_reset_reset),                                    //                     reset.reset
		.uav_address            (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (Stream_to_Mem_avalon_dma_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (Stream_to_Mem_avalon_dma_master_waitrequest),                                        //                          .waitrequest
		.av_write               (Stream_to_Mem_avalon_dma_master_write),                                              //                          .write
		.av_writedata           (Stream_to_Mem_avalon_dma_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) stream_to_mem_avalon_dma_master_agent (
		.clk                   (pll_sys_outclk2_clk),                                                                //       clk.clk
		.reset                 (Stream_to_Mem_reset_reset_bridge_in_reset_reset),                                    // clk_reset.reset
		.av_address            (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (stream_to_mem_avalon_dma_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (stream_to_mem_avalon_dma_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (stream_to_mem_avalon_dma_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (stream_to_mem_avalon_dma_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (stream_to_mem_avalon_dma_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (stream_to_mem_avalon_dma_master_agent_cp_ready),                                     //          .ready
	...
	soc_system_mm_interconnect_0_router router (
		.sink_ready         (stream_to_mem_avalon_dma_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (stream_to_mem_avalon_dma_master_agent_cp_valid),         //          .valid
		.sink_data          (stream_to_mem_avalon_dma_master_agent_cp_data),          //          .data
		.sink_startofpacket (stream_to_mem_avalon_dma_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (stream_to_mem_avalon_dma_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (pll_sys_outclk2_clk),                                    //       clk.clk
		.reset              (Stream_to_Mem_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
